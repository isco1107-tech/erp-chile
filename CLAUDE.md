...
- **Estructura de Carpetas:** Enfoque modular por dominio en `src/modules/`. **41 módulos existen hoy**; la lista completa se obtiene con `ls src/modules/`. Los principales, por área:
