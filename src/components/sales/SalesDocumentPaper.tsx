...
/**
 * Representación impresa de un documento de venta (con timbre PDF417 si fue
 * timbrado). Componente de servidor compartido entre el detalle de Ventas y
 * el portal del cliente, para que ambos muestren exactamente el mismo papel.
 */
export default function SalesDocumentPaper({ doc, esCedible = false }: { doc: SalesDocumentWithRelations; esCedible?: boolean }) {
