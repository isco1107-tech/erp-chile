...
describe('ítems apagados por la empresa', () => {
  it('desaparecen del menú y el grupo vacío también', () => {
    const groups = buildWorkspaceNav({ ...FULL_ACCESS, disabledNavItems: ['purchases', 'purchase-requests', 'purchase-orders', 'purchases-imports', 'purchases-inbox', 'invoice-archive'] });
